...
/**
 * Verifies the {@link com.aaravlabs.pubsub.annotation.OnHardwareThread @OnHardwareThread}
...
class HardwareThreadTest {
    ...
    void nonHardwareCallbacksStillRunOnCallbackPool() throws Exception {
        ...
        // Callback-pool threads are named with the "pubsub-hw-test-" prefix via
        // our ThreadFactory. Hardware thread uses "pubsub-hw-test-hw-" prefix.
