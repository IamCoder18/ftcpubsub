 ...
 *
 * <ul>
 *   <li>{@link com.aaravlabs.pubsub.annotation.SubscribedTo} on methods — invoked when
 *       their topic receives a message.</li>
 *   <li>{@link com.aaravlabs.pubsub.annotation.RunPeriodically} on methods — invoked on
 *       a fixed-rate loop.</li>
 *   <li>{@link com.aaravlabs.pubsub.annotation.RunnableAction} on methods — registered
