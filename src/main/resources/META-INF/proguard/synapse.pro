# R8/ProGuard keep rules for com.aaravlabs:synapse.
#
...
# Keep the public API of the synapse library.
-keep public class com.aaravlabs.synapse.** { public *; }
-keep public interface com.aaravlabs.synapse.** { *; }
-keep public class com.aaravlabs.synapse.ftc.** { public *; }

# Keep internals (the annotation binder scans them by reflection).
-keep class com.aaravlabs.synapse.internal.** { *; }
